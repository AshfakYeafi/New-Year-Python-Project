...
entry_info = 'Happy New Year 2022'


vector = pygame.math.Vector2
gravity = vector(0.01, 0.3)
DISPLAY_WIDTH , DISPLAY_HEIGHT =1024,768

trail_colours = [(45, 45, 45), (60, 60, 60), (75, 75, 75), (125, 125, 125), (150, 150, 150)]
dynamic_offset = 1
static_offset = 5
bg=pygame.image.load('1024x768-341250-Sunset-Starry-Night-Sky-Moon-Stars-Anime-Scenery.jpg')
...
class textWavey:
    ...
    def animate(self):
        ...
        for step in self.steps:
            ...
            dst = src.move(0, math.cos(self.offset + step * .01) * self.amount)
